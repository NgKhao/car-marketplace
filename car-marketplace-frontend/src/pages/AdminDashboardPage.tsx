      ...
      <Box component='main' sx={{ flexGrow: 1, p: 3 }}>
        ...
        <Box sx={{ mb: 4 }}>
          <Typography variant='h4' component='h1' gutterBottom>
            ...
            {activeMenuItem === 'analytics' && 'Thống kê'}
            {activeMenuItem === 'settings' && 'Cài đặt'}
          </Typography>
          <Typography variant='body1' color='text.secondary'>
            {activeMenuItem === 'users' &&
              'Quản lý tài khoản người dùng trong hệ thống'}
            {activeMenuItem === 'cars' &&
              'Quản lý các bài đăng xe của người dùng'}
            {activeMenuItem === 'analytics' &&
              'Xem báo cáo và thống kê hệ thống'}
            {activeMenuItem === 'settings' && 'Cấu hình hệ thống'}
          </Typography>
        </Box>
              ...
              <Card sx={{ minWidth: 200, flex: 1 }}>
                <CardContent sx={{ display: 'flex', alignItems: 'center' }}>
                  ...
                  <Box>
                    <Typography variant='h5' fontWeight='bold'>
                      {
                        users.filter((u) => u.role !== 'admin' && u.isVerified)
                          .length
                      }
                    </Typography>
                    <Typography variant='body2' color='text.secondary'>
        ...
        {activeMenuItem === 'cars' && (
          <Box>
            <Typography variant='h6'>
              Tính năng quản lý bài đăng xe sẽ được phát triển...
            </Typography>
          </Box>
        )}
        ...
        {activeMenuItem === 'analytics' && (
          <Box>
            <Typography variant='h6'>
              Tính năng thống kê sẽ được phát triển...
            </Typography>
          </Box>
        )}
        ...
        {activeMenuItem === 'settings' && (
          <Box>
            <Typography variant='h6'>
              Tính năng cài đặt sẽ được phát triển...
            </Typography>
          </Box>
        )}
      </Box>
